...
#     n = 30
#     zsample = np.linspace(-1.5,1.5,n).reshape(n,1)#0.5*np.random.normal(size=[n,n_zrand])#
#     Mdist = []
#     Edist = []
#     mean_magnetization = []
#     var_magnetization = []
...
#             # print(energy)
#             # for p in range(n):
#             #     draw_grid(8,gsample[p],T_vals[i])
#             fig1 = plt.figure(1)
...
#         print(tvd_mag)
#         print((np.array(mean_magnetization)-np.array(mean_magnetization_data))**2)
...
#         print(tvd_energy)
#         print([(np.array(mean_energy)- np.array(mean_energy_data))**2])
